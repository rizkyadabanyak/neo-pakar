...
const permissionsHelper = {
    ...
    listPermission: () => {
        const data = {
            ...
            candidate_behavior : ['can_show_detail_profile','can_update_profile_candidate_behavior','can_add_skill_candidate_behavior','can_apply_job_candidate','can_accept_offer_candidate','can_show_apply_job_candidate','can_all_candidate_behavior'],
            company_behavior : ['can_show_detail_profile_company','can_update_profile_company_behavior','can_given_offer_company_behavior','can_show_apply_job_company_behavior','can_show_candidate','can_accept_Applications_behavior','can_all_company_behavior'],
        };
        return data;
    },
